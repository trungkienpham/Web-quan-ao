    ...
    registerEvents: function () {
        ...
        $('#btnChooseImages').off('click').on('click', function (e) {
            ...
            finder.selectActionFunction = function (url) {
                $('#imageList').append('<div style="float:left"><img src="' + url + '" width="40" height="50" /><a href="#" class="btn-delImage"><i class="fa fa-times"></i></a></div>');
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(data, function (i, item) {
                    html += '<div style="float:left"><img src="' + item + '" width="40" height="50" /><a href="#" class="btn-delImage"><i class="fa fa-times"></i></a></div>'
                });
                $('#imageList').html(html);
